  ...
  const sendTip = async () => {
    ...
    try {
      ...
      if (!contract || contract.address === "0x0000000000000000000000000000000000000000") {
        ...
        setSuccess(
          `Successfully sent ${amount} ${currencySymbol} to ${recipient.substring(0, 6)}...${recipient.substring(38)}`,
        )

        // Show toast notification
        toast({
          title: "Tip Sent Successfully",
          description: `You sent ${amount} ${currencySymbol} to ${recipient.substring(0, 6)}...${recipient.substring(38)}`,
        })
      ...
      const tx = await contract.sendTip(recipient, message, {
        value: amountInWei,
      })
