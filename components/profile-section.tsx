  ...
  const loadProfile = async () => {
    ...
    try {
      ...
      try {
        ...
        if (
          profileErr.reason === "Profile does not exist" ||
          (profileErr.message && profileErr.message.includes("Profile does not exist"))
        ) {
          // This is expected for new users, don't show an error
          console.log("No profile exists yet, user can create one")
          setProfileExists(false)
        } else {
          // This is an unexpected error, show it to the user
          throw profileErr
        }
      }
    } catch (err) {
      ...
      <Card>
        ...
        <CardContent className="flex flex-col items-center text-center">
          ...
          <div className="w-full mt-6 pt-6 border-t">
            ...
            {profileExists && typeof window !== "undefined" ? (
              <>
