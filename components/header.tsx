            ...
            <TooltipProvider>
              <Tooltip>
                <TooltipTrigger asChild>
                  <Button variant="destructive" size="sm" className="flex items-center gap-1" onClick={onSwitchNetwork}>
            ...
            <>
              <div className="hidden md:flex items-center gap-2">
                ...
                <div className="flex items-center">
                  ...
                  <span className="ml-1 text-sm text-muted-foreground">STT</span>
